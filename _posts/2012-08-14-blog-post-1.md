...
The challenge will be to code up your own project which exhibits a set
of potential weaknesses that would be feasible in the framework below
and provide a written description of the cause, effect, and mitigation.
Ideally they should focus on critical weaknesses. Both the write-up and
set of source files are to be submitted.

1.  Research and play around with the Java MVC 1.0 (aka Ozark)
    > framework. Feel free to use the following links or any other
    > information you can get a hold of:

<!-- -->

1.  [[https://www.oracle.com/technetwork/articles/java/mvc-2280472.html]{.underline}](https://www.oracle.com/technetwork/articles/java/mvc-2280472.html)

2.  [[https://www.mvc-spec.org/ozark/]{.underline}](https://www.mvc-spec.org/ozark/)

3.  [[https://www.javacodegeeks.com/2015/09/java-ee-8-mvc-getting-started-with-ozark.html]{.underline}](https://www.javacodegeeks.com/2015/09/java-ee-8-mvc-getting-started-with-ozark.html)

4.  [[https://jcp.org/en/jsr/detail?id=371]{.underline}](https://jcp.org/en/jsr/detail?id=371)

<!-- -->

2.  Identify two or more vulnerabilities that applications written using
    > Ozark might be susceptible to and describe the conditions under
    > which applications may be vulnerable to them. This is an
    > opportunity to display your ability to research a framework,
    > understand its architecture, and display how applications can be
    > written insecurely using it. Feel free to refer to
    > [[https://vulncat.fortify.com/en]{.underline}](https://vulncat.fortify.com/en)
    > for a list of potential vulnerability types to explore, however,
    > refrain from pursuing Code Quality issues. Preference would be for
    > critical weakness categories (especially those which may be unique
    > to the framework).

3.  Write a test case for each of the identified vulnerabilities to
    > illustrate how they manifest themselves in the code of the
    > application (no specific requirement with respect to frontends to
    > be used). There is no need to provide an exploit -- just the code
    > that may be vulnerable.

4.  Describe in plain English (or pseudo code, if you prefer) the
    > algorithm and information necessary to detect these
    > vulnerabilities in the code.

If you have any questions regarding the assignment, please let me know
and we can have a call to answer any questions you may have. Ideally, we
would like to have a solution back by **Friday, September 23^rd^, 2019
(midnight PST)**. If you need more time, considering work and family
commitments, please let me know.

**Task \#1 \[Research & Threat Modeling\]:**
...
> ![](media/image1.png){width="3.6458333333333335in" height="0.8125in"}
>
> Fig 1: Threat Model for Ozark App.

The two exposed weakness are:

**\[V1\] Cross-Site Scripting (XSS): Reflected**
...
![](media/image2.png){width="6.5in" height="1.9583333333333333in"}
...
![](media/image8.png){width="6.5in" height="3.4305555555555554in"}
...
![](media/image5.png){width="6.5in" height="1.0833333333333333in"}

![](media/image7.png){width="6.5in" height="2.4583333333333335in"}

![](media/image9.png){width="6.5in" height="2.6527777777777777in"}
...
![](media/image3.png){width="6.5in" height="1.5in"}
...
![](media/image6.png){width="6.5in" height="0.9305555555555556in"}
